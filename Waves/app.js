    ...
    case "beats":
      return `
        ...
        <div class="interactive-scene">
          ...
          <div class="scene-controls">
            <label><span>&nu;<sub>s</sub> (Hz): </span><input type="range" id="beats-f1" min="0.5" max="3" step="0.05" value="1.0"><span class="scene-val" id="beats-f1-val">1.00</span></label>
            <label><span>&nu;<sub>a</sub> (Hz): </span><input type="range" id="beats-f2" min="0.5" max="3" step="0.05" value="1.15"><span class="scene-val" id="beats-f2-val">1.15</span></label>
          </div>
        </div>
      `;
      ...
      return `
        <div class="interactive-scene">
          ...
          <div class="scene-controls">
            ...
            <button id="nchain-long-btn" class="scene-btn" style="font-size:11px;padding:2px 10px;cursor:pointer;">Longitudinal</button>
            <button id="nchain-trans-btn" class="scene-btn scene-btn-active" style="font-size:11px;padding:2px 10px;cursor:pointer;">Transverse</button>
          </div>
        </div>
      `;
    ...
    case "sound-wave-longitudinal":
      return `
        ...
        <div class="interactive-scene">
          ...
          <div class="scene-controls">
            <label><span>Frequency: </span><input type="range" id="swl-freq" min="0.5" max="3" step="0.1" value="1.2"><span class="scene-val" id="swl-freq-val">1.2</span></label>
            <label><span>Amplitude: </span><input type="range" id="swl-amp" min="0.3" max="1.5" step="0.1" value="0.8"><span class="scene-val" id="swl-amp-val">0.8</span></label>
            <label><span>Speed: </span><input type="range" id="swl-speed" min="0.005" max="0.04" step="0.005" value="0.015"><span class="scene-val" id="swl-speed-val">0.50x</span></label>
          </div>
        </div>
      `;
      ...
      ${longProblems.map((prob, i) => `
        <details class="long-problem">
          ...
          <div class="long-problem-body">
            ${prob.image ? `<img class="long-problem-image" src="${prob.image}" alt="${prob.imageAlt || ""}" loading="lazy">` : ""}
